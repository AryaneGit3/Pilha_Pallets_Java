...
public class FormSistema extends javax.swing.JFrame {
    ...
    prod.setDescricao(txtProduto.getText());
    // convertendo uma string para inteiro:
    prod.setQuantidade(Integer.parseInt(txtQtd.getText()));
    // inserindo o meu prod na pilha
    minhaPilha.push(prod);
    // chama metodo mostra e passa parametros:
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        while(!minhaPilha.isEmpty()){
          // p esta sendo considerada com elemento do topo: 
          p = minhaPilha.peek();
          // comparando a descrição
          if(p.getDescricao().equals(txtProduto.getText())){
                p = minhaPilha.pop();
            if (p.getQuantidade() <= (Integer.parseInt(txtQtd.getText()))){
                // exibe caixa de texto
                JOptionPane.showMessageDialog(null,"Produto Removido!");
              
            }// fim if 2
            
            else {
                // subtraindo qtd real pela qtd requisitada:
              ...
              // retirando do topo da pilha e inserindo em p:
              p = minhaPilha.pop();
            ...
            // enquanto pilhaAux não estiver vazia:
        while (!pilhaAuxiliar.isEmpty()){
            p = pilhaAuxiliar.pop(); // removendo p da pilhaAux
            minhaPilha.push(p); // inserindo p na pilha Original
            mostraPilha(minhaPilha, listPilha); // atualizando
            mostraPilha(pilhaAuxiliar, listAux);
